...
//TODO: test this code
        RequestMatcher rm = (HttpServletRequest hsr) -> hsr.getQueryString().equals("/token");
        JWTBearerClientAssertionTokenEndpointFilter filter = new JWTBearerClientAssertionTokenEndpointFilter(rm); //"/token"
