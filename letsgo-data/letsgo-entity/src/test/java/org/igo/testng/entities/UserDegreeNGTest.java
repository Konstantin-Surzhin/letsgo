 ...
 * @author pl
 */
public class UserDegreeNGTest {
    
    public UserDegreeNGTest() {
    }
    ...
    /**
     * Тест метод getUserDegreePK, класса UserDegree.
     */
    @org.testng.annotations.Test
    public void testGetUserDegreePK() {
        System.out.println("getUserDegreePK");
    ...
    /**
     * Тест метод setUserDegreePK, класса UserDegree.
     */
    @org.testng.annotations.Test
    public void testSetUserDegreePK() {
        System.out.println("setUserDegreePK");
        UserDegreePK userDegreePK = null;
        UserDegree instance = new UserDegree();
        instance.setUserDegreePK(userDegreePK);
        // Просмотр списка задач TODO для сгенерированного кода теста и удаление вызова по умолчанию для случаев сбоя.
        fail("\u042d\u0442\u043e\u0442 \u0442\u0435\u0441\u0442 \u044f\u0432\u043b\u044f\u0435\u0442\u0441\u044f \u043f\u0440\u043e\u0442\u043e\u0442\u0438\u043f\u043e\u043c.");
    }

    /**
     * Тест метод getDegreeType, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод setDegreeType, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод getUsers, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод setUsers, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод getDegreeId, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод setDegreeId, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод hashCode, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод equals, класса UserDegree.
     */
    @org.testng.annotations.Test
    ...
    /**
     * Тест метод toString, класса UserDegree.
     */
    @org.testng.annotations.Test
