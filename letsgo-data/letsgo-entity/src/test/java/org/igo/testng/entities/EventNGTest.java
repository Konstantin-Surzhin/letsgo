...
public class EventNGTest {
    ...
    /**
     * Тест метод getEventName, класса Event.
     */
    @Test
    ...
    /**
     * Тест метод setEventName, класса Event.
     */
    @Test
    ...
    /**
     * Тест метод getGamesCollection, класса Event.
     */
    @Test
    public void testGetGamesCollection() {
        ...
        Collection result = instance.getGamesCollection();
        assertEquals(result, expResult);
        // Просмотр списка задач TODO для сгенерированного кода теста и удаление вызова по умолчанию для случаев сбоя.
        fail("\u042d\u0442\u043e\u0442 \u0442\u0435\u0441\u0442 \u044f\u0432\u043b\u044f\u0435\u0442\u0441\u044f \u043f\u0440\u043e\u0442\u043e\u0442\u0438\u043f\u043e\u043c.");
    }
    ...
    /**
     * Тест метод setGamesCollection, класса Event.
     */
    @Test
    ...
    /**
     * Тест метод hashCode, класса Event.
     */
    @Test
    ...
    /**
     * Тест метод equals, класса Event.
     */
    @Test
    ...
    /**
     * Тест метод toString, класса Event.
     */
    @Test
