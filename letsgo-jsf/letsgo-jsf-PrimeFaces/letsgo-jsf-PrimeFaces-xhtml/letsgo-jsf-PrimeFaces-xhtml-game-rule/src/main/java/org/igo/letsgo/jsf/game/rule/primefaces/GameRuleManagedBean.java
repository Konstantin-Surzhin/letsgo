 ...
 */
package org.igo.letsgo.jsf.game.rule.primefaces;
 ...
 */
@SessionScoped
@ManagedBean(name="GameRuleManagedBean")
public class GameRuleManagedBean implements Serializable {

    private String gameRuleName="Правила игры!!!";
    private String pageHeader="Управление правилами игры";
