 ...
 */
package org.igo.letsgo.spring.controler.game.comment;
...
public class GameCommentController {
    ...
    @GetMapping(value = "/gameComment")
    public String index(Model model) {
        model.addAttribute("game_comment", new GameComment());
        model.addAttribute("game_comment_head", java.util.ResourceBundle.getBundle("City").getString("game_comment_head"));
